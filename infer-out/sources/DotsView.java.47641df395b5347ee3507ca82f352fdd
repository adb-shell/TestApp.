...
/**
 * Created by karthikrk on 05/01/16.
 */
public class DotsView extends View {
    private static final int DOTS_COUNT = 7;
    private static final int OUTER_DOTS_POSITION_ANGLE = 51;

    private static final int COLOR_4 = 0xFFE5E5E5;
    private static final int COLOR_3 = 0xFFA5A5A5;
    private static final int COLOR_2 = 0xFF656565;
    private static final int COLOR_1 = 0xFF4B4B4B;
